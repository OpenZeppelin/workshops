...
import "argent-contracts/contracts/wallet/Proxy.sol";
import "argent-contracts/contracts/wallet/BaseWallet.sol";
import "argent-contracts/contracts/infrastructure/base/Owned.sol";
import "argent-contracts/contracts/infrastructure/base/ManagedV2.sol";
import "argent-contracts/contracts/infrastructure/storage/IGuardianStorage.sol";
import "argent-contracts/contracts/modules/common/IVersionManager.sol";
import "argent-contracts/contracts/modules/common/Utils.sol";
 ...
 */
contract WalletFactoryClones is ManagedV2 {
    ...
    */
        ...
        returns (address _wallet)
    {
        ...
        address payable wallet = payable(Clones.cloneDeterministic(walletImplementation, newsalt));
        ...
        returns (address _wallet)
    {
        validateInputs(_owner, _versionManager, _guardian, _version);
        bytes32 newsalt = newSalt(_salt, _owner, _versionManager, _guardian, _version);
        _wallet = Clones.predictDeterministicAddress(walletImplementation, newsalt);
    }
